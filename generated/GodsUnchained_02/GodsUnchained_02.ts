...
export class GodsUnchained_02 extends ethereum.SmartContract {
  ...
  try_getBatch(
    index: BigInt
  ): ethereum.CallResult<GodsUnchained_02__getBatchResult> {
    let result = super.tryCall(
      "getBatch",
  ...
  try_protos(
    param0: BigInt
  ): ethereum.CallResult<GodsUnchained_02__protosResult> {
    let result = super.tryCall(
      "protos",
      "protos(uint256):(bool,bool,uint8,uint8,uint8,uint8,uint8,uint8,uint8)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  try_batches(
    param0: BigInt
  ): ethereum.CallResult<GodsUnchained_02__batchesResult> {
  ...
  try_getDetails(
    tokenId: BigInt
  ): ethereum.CallResult<GodsUnchained_02__getDetailsResult> {
    let result = super.tryCall(
      "getDetails",
      "getDetails(uint256):(uint16,uint8)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
  ...
  try_seasons(
    param0: BigInt
  ): ethereum.CallResult<GodsUnchained_02__seasonsResult> {
